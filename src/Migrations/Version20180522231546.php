 ...
 */
class Version20180522231546 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE table_jeu (id INT NOT NULL, type_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description TEXT NOT NULL, ville VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, email_organisateur VARCHAR(60) NOT NULL, telephone VARCHAR(40) DEFAULT NULL, PRIMARY KEY(id))');
